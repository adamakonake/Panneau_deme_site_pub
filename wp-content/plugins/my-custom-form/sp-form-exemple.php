...
/*
Plugin Name: Panneau deme Contact Form Plugin
...
*/
    ...
    function html_form_code(){
        ...
        echo '</p>';
        echo '<p>';
        echo "<span style='color : white;'>Votre Message <span style ='color : red;'>*</span><br />";
    ...
    function deliver_mail() {
        ...
        if ( isset( $_POST['cf-submitted'] ) ) {
            ...
            try {
                ...
                //Recipients
                $mail->setFrom('bamakosheraton@gmail.com','Panneau Deme');
                $mail->addAddress($to);     //Add a recipient
        
                $headers = "From: $name <$email>" . "\r\n";

                $mail->addReplyTo($email, $name);
                $mail->Subject = 'Contact Panneau Deme';
                $mail->isHTML(false);
                $mail->Body = <<<EOT
                E-mail: $email
                Nom: $name
    ...
    add_shortcode( 'panneauDeme_contact_form', 'cf_shortcode' );
?>